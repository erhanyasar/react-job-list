...
export default class FormInput extends React.Component {
  ...
  isValid = () => {
    // By disabling the 'Create Button' on default, user forced to type or select inputs so that half-validation gained.
    ...
    if (
      ...
      this.state.jobNameInput &&
      !regExp.test(this.state.jobNameInput)
    ) {
  ...
  render() {
    const prioritySelectbox = this.state.priorities
